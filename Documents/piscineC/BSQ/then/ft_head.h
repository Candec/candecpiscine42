...
/*   Updated: 2020/11/11 23:35:05 by jibanez-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_update_obst(char **grid,
int **temp_grid, t_map_info map);
void				ft_propagate(char **grid, int **temp_grid, t_map_info map);
void				ft_draw_solution(char **grid,
t_solution sol, t_map_info map);
